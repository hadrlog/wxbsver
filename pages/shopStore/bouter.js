...
Page({
  ...
  outStoreAction:function(){
    ...
    api.Cpic_fetchPost(api.OUTERSTORE, { "bussiness_date": ctime, "hander_user": handle_user, "supplier_no": '', "shop_no": shopnum, "bill_no": '', "other_price": '0', "remark": '','check_data': outArr}, (err, res) => {
      console.log("err:" + err + "DIC:" + res.ReturnMsg + 'GROUP：' + res.data);
      var taxt = '';
      if (err == "00") {
        taxt = '成功';
